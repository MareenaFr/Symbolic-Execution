...
int main(int argc, char* argv[])
{
  ...
  convert_to_zero(value1);

  char str3[SIZE];
  int value2;
  klee_make_symbolic(str3, sizeof(str3), "str3");
  klee_make_symbolic(&value2, sizeof(value2), "value2");
  append_zeros(str3, value2);

  char str4[SIZE];
  int value3;
  klee_make_symbolic(str4, sizeof(str4), "str4");
  klee_make_symbolic(&value3, sizeof(value3), "value3");
  shift(str4, value3);

  char str5[SIZE], str6[SIZE];
  klee_make_symbolic(str5, sizeof(str5), "str5");
  klee_make_symbolic(str6, sizeof(str6), "str6");
  mull_small(str5, str6);

  char intal1[SIZE], intal2[SIZE];
  klee_make_symbolic(intal1, sizeof(intal1), "intal1");
  klee_make_symbolic(intal2, sizeof(intal2), "intal2");
  intal_pow(intal1, intal2);

  char intal3[SIZE], intal4[SIZE];
  klee_make_symbolic(intal3, sizeof(intal3), "intal3");
  klee_make_symbolic(intal4, sizeof(intal4), "intal4");
  intal_compare(intal3, intal4);

  char intal5[SIZE], intal6[SIZE];
  klee_make_symbolic(intal5, sizeof(intal5), "intal5");
  klee_make_symbolic(intal6, sizeof(intal6), "intal6");
  intal_divide(intal5, intal6);

  char intal7[SIZE], intal8[SIZE];
  klee_make_symbolic(intal7, sizeof(intal7), "intal7");
  klee_make_symbolic(intal8, sizeof(intal8), "intal8");
  intal_diff(intal7, intal8);

  char intal9[SIZE], intal10[SIZE];
  klee_make_symbolic(intal9, sizeof(intal9), "intal9");
  klee_make_symbolic(intal10, sizeof(intal10), "intal10");
  intal_multiply(intal9, intal10);

  char intal13[SIZE];
  klee_make_symbolic(intal13, sizeof(intal13), "intal13");
  intal_increment(intal13);

  char intal14[SIZE];
  klee_make_symbolic(intal14, sizeof(intal14), "intal14");
  intal_decrement(intal14);

  char intal15[SIZE], intal18[SIZE];
  klee_make_symbolic(intal15, sizeof(intal15), "intal15");
  klee_make_symbolic(intal18, sizeof(intal18), "intal18");
  intal_add(intal15, intal18);

  char intal16[SIZE];
  klee_make_symbolic(intal16, sizeof(intal16), "intal16");
  intal_destroy(intal16);

  char intal17[SIZE];
  klee_make_symbolic(intal17, sizeof(intal17), "intal17");
  intal2str(intal17);
